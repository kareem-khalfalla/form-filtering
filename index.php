                ...
                <div class="row">
                    ...
                    <div class="large-4 medium-6 small-12 columns">
                        ...
                        <ul class="inline-list">
                            <li>
                                <label for="cover_0">
                                    <input type="radio" name="cover" id="cover_0" value=""> Any
                                </label>
                            </li>
                        </ul>
                    </div>
                ...
                <ul class="inline-list">
                    <li>
                        <label for="location_1">
                            <input type="checkbox" name="location[]" id="location_1" value="1"> Option
                        </label>
                    </li>
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="large-4 medium-6 small-12 columns large-offset-4 medium-offset-3">
                        ...
                        <div class="expanded button-group">
                            <a href="/" class="alert button"><i class="fa fa-times"></i> RESET</a>
